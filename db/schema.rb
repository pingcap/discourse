...
ActiveRecord::Schema.define(version: 2021_10_06_223156) do
  ...
  create_table "anonymous_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "application_requests", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "assignments", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["assigned_to_id", "assigned_to_type", "target_id", "target_type"], name: "unique_target_and_assigned", unique: true
    t.index ["assigned_to_id", "assigned_to_type"], name: "index_assignments_on_assigned_to_id_and_assigned_to_type"
    t.index ["target_id", "target_type"], name: "index_assignments_on_target_id_and_target_type", unique: true
    t.index ["topic_id"], name: "index_assignments_on_topic_id", unique: true
  end
  ...
  create_table "badge_groupings", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
  ...
  create_table "badge_types", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "categories", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index "(coalesce(`parent_category_id`, -1)), (lower(`slug`))", name: "unique_index_categories_on_slug"
  ...
  create_table "categories_web_hooks", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "web_hook_id", null: false
    t.integer "category_id", null: false
    t.index ["web_hook_id", "category_id"], name: "index_categories_web_hooks_on_web_hook_id_and_category_id", unique: true
  end

  create_table "category_custom_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
  ...
  create_table "category_featured_topics", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
    t.integer "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "category_groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
  ...
  create_table "category_search_data", primary_key: "category_id", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "search_data"
    t.text "raw_data"
    t.text "locale"
  ...
  create_table "category_tag_groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
  ...
  create_table "category_tag_stats", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "category_tags", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
  ...
  create_table "category_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "category_id", null: false
    t.integer "user_id", null: false
  ...
  create_table "child_themes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "color_scheme_colors", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "color_schemes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "custom_emojis", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "developers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "directory_items", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "draft_sequences", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "email_change_requests", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "old_email"
  ...
  create_table "email_logs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["topic_id"], name: "index_email_logs_on_topic_id"
    t.index ["user_id"], name: "index_email_logs_on_user_id"
  end

  create_table "email_tokens", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "embeddable_hosts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "external_upload_stubs", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "multipart", default: false, null: false
    t.string "external_upload_identifier"
    t.bigint "filesize", null: false
    t.index ["created_by_id"], name: "index_external_upload_stubs_on_created_by_id"
    t.index ["external_upload_identifier"], name: "index_external_upload_stubs_on_external_upload_identifier"
    t.index ["key"], name: "index_external_upload_stubs_on_key", unique: true
    t.index ["status"], name: "index_external_upload_stubs_on_status"
  end

  create_table "given_daily_likes", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "likes_given", null: false
  ...
  create_table "group_archived_messages", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id", null: false
    t.integer "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "group_custom_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id", null: false
    t.string "name", limit: 256, null: false
    t.text "value"
    t.datetime "created_at", null: false
  ...
  create_table "group_histories", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id", null: false
  ...
  create_table "group_mentions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id"
    t.integer "group_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "group_requests", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id"
    t.integer "user_id"
    t.text "reason"
    t.datetime "created_at", null: false
  ...
  create_table "group_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "assignable_level", default: 0, null: false
    t.index ["incoming_email"], name: "index_groups_on_incoming_email", unique: true
    t.index ["name"], name: "index_groups_on_name", unique: true
  end

  create_table "groups_web_hooks", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "web_hook_id", null: false
    t.integer "group_id", null: false
    t.index ["web_hook_id", "group_id"], name: "index_groups_web_hooks_on_web_hook_id_and_group_id", unique: true
  end

  create_table "ignored_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "incoming_domains", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "incoming_emails", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "topic_id"
    t.integer "post_id"
    t.text "raw"
  ...
  create_table "incoming_links", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "user_id"
    t.string "ip_address"
  ...
  create_table "incoming_referers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "invited_groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id"
    t.integer "invite_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "javascript_caches", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "message_bus", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "context"
    t.text "data"
    t.datetime "created_at", null: false
  ...
  create_table "muted_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "notifications", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "id", "read", "topic_id"], name: "index_notifications_read_or_not_high_priority"
    t.index ["user_id", "id"], name: "index_notifications_unique_unread_high_priority"
  ...
  create_table "oauth2_user_infos", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "onceoff_logs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "job_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "one_row_table", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "id"
  end

  create_table "optimized_images", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "permalinks", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "plugin_store_rows", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "poll_votes", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "poll_id"
  ...
  create_table "post_action_types", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "post_actions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id", null: false
    t.integer "user_id", null: false
    ...
    t.index ["user_id", "post_action_type_id", "post_id", "targets_topic"], name: "idx_unique_actions"
    t.index ["user_id", "post_action_type_id"], name: "index_post_actions_on_user_id_and_post_action_type_id"
    t.index ["user_id", "post_id", "targets_topic"], name: "idx_unique_flags"
    t.index ["user_id"], name: "index_post_actions_on_user_id"
  end

  create_table "post_custom_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id", null: false
    t.string "name", limit: 256, null: false
    t.text "value"
    t.datetime "created_at", null: false
    ...
    t.index ["post_id"], name: "index_post_custom_fields_on_notice"
  end

  create_table "post_details", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id"
    t.string "key"
    t.string "value"
    t.text "extra"
  ...
  create_table "post_replies", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "post_reply_keys", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "post_id", null: false
  ...
  create_table "post_revisions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "post_id"
    t.text "modifications", size: :long
    t.integer "number"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "hidden", default: false, null: false
  ...
  create_table "post_search_data", primary_key: "post_id", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "search_data"
    t.text "raw_data"
    t.string "locale"
    t.integer "version", default: 0
  ...
  create_table "post_stats", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id"
  ...
  create_table "post_timings", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
  ...
  create_table "post_uploads", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id", null: false
    t.integer "upload_id", null: false
  ...
  create_table "posts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", comment: "If you want to query public posts only, use the badge_posts view.", force: :cascade do |t|
    t.integer "user_id"
    t.integer "topic_id", null: false
    ...
    t.text "raw", size: :long, null: false, comment: "The raw Markdown that the user entered into the composer."
    t.text "cooked", size: :long, null: false, comment: "The processed HTML that is presented in a topic."
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.index ["id", "baked_version"], name: "index_posts_on_id_and_baked_version"
    t.index ["id"], name: "index_for_rebake_old"
    ...
    t.index ["user_id", "like_count", "created_at"], name: "index_posts_user_and_likes"
  ...
  create_table "quoted_posts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "post_id", null: false
  ...
  create_table "remote_themes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "reviewable_claimed_topics", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "reviewable_histories", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "reviewable_scores", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "reviewable_id", null: false
    t.integer "user_id", null: false
  ...
  create_table "reviewables", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["target_id"], name: "index_reviewables_on_target_id_where_post_type_eq_post"
    t.index ["topic_id", "status", "created_by_id"], name: "index_reviewables_on_topic_id_and_status_and_created_by_id"
    t.index ["type", "target_id"], name: "index_reviewables_on_type_and_target_id"
  end

  create_table "scheduler_stats", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "schema_migration_details", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "screened_emails", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "email", null: false
  ...
  create_table "screened_ip_addresses", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "screened_urls", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "url", null: false
  ...
  create_table "shared_drafts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "category_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "single_sign_on_records", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "skipped_email_logs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "email_type", null: false
    t.string "to_address", null: false
    t.integer "user_id"
    t.integer "post_id"
  ...
  create_table "stylesheet_cache", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "tag_group_memberships", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "tag_id", null: false
    t.integer "tag_group_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "tag_group_permissions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "tag_groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "tag_search_data", primary_key: "tag_id", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "search_data"
    t.text "raw_data"
    t.text "locale"
    t.integer "version", default: 0
  ...
  create_table "tag_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "tag_id", null: false
    t.integer "user_id", null: false
    t.integer "notification_level", null: false
    t.datetime "created_at", null: false
  ...
  create_table "tags_web_hooks", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "web_hook_id", null: false
    t.bigint "tag_id", null: false
    t.index ["web_hook_id", "tag_id"], name: "web_hooks_tags", unique: true
  end

  create_table "theme_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "theme_modifier_sets", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.json "svg_icons"
    t.json "topic_thumbnail_sizes"
    t.index ["theme_id"], name: "index_theme_modifier_sets_on_theme_id", unique: true
  end

  create_table "theme_settings", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.integer "data_type", null: false
    t.text "value"
    t.integer "theme_id", null: false
  ...
  create_table "theme_translation_overrides", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "theme_id", null: false
  ...
  create_table "themes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "top_topics", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id"
    ...
    t.index ["daily_likes_count"], name: "index_top_topics_on_daily_likes_count"
    t.index ["daily_op_likes_count"], name: "index_top_topics_on_daily_op_likes_count"
    t.index ["daily_posts_count"], name: "index_top_topics_on_daily_posts_count"
    t.index ["daily_score"], name: "index_top_topics_on_daily_score"
    t.index ["daily_views_count"], name: "index_top_topics_on_daily_views_count"
    t.index ["monthly_likes_count"], name: "index_top_topics_on_monthly_likes_count"
    t.index ["monthly_op_likes_count"], name: "index_top_topics_on_monthly_op_likes_count"
    t.index ["monthly_posts_count"], name: "index_top_topics_on_monthly_posts_count"
    t.index ["monthly_score"], name: "index_top_topics_on_monthly_score"
    t.index ["monthly_views_count"], name: "index_top_topics_on_monthly_views_count"
    ...
    t.index ["weekly_likes_count"], name: "index_top_topics_on_weekly_likes_count"
    t.index ["weekly_op_likes_count"], name: "index_top_topics_on_weekly_op_likes_count"
    t.index ["weekly_posts_count"], name: "index_top_topics_on_weekly_posts_count"
    t.index ["weekly_score"], name: "index_top_topics_on_weekly_score"
    t.index ["weekly_views_count"], name: "index_top_topics_on_weekly_views_count"
    t.index ["yearly_likes_count"], name: "index_top_topics_on_yearly_likes_count"
    t.index ["yearly_op_likes_count"], name: "index_top_topics_on_yearly_op_likes_count"
    t.index ["yearly_posts_count"], name: "index_top_topics_on_yearly_posts_count"
  ...
  create_table "topic_allowed_groups", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "group_id", null: false
    t.integer "topic_id", null: false
  ...
  create_table "topic_allowed_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topic_custom_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.string "name", limit: 256, null: false
    t.text "value"
    t.datetime "created_at", null: false
    ...
    t.index ["topic_id"], name: "idx_topic_custom_fields_accepted_answer"
  end

  create_table "topic_embeds", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "post_id", null: false
  ...
  create_table "topic_invites", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "invite_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topic_link_clicks", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "topic_links", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "post_id"
    t.integer "user_id", null: false
    t.string "url", null: false
    ...
    t.index ["user_id", "clicks", "created_at"], name: "index_topic_links_on_user_and_clicks"
    t.index ["user_id"], name: "index_topic_links_on_user_id"
  end

  create_table "topic_search_data", primary_key: "topic_id", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "raw_data"
    t.string "locale", null: false
    t.text "search_data"
    t.integer "version", default: 0
  ...
  create_table "topic_tags", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topic_timers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "topic_users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "topic_id", null: false
  ...
  create_table "topic_views", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
  ...
  create_table "topics", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", comment: "To query public topics only: SELECT ... FROM topics t LEFT INNER JOIN categories c ON (t.category_id = c.id AND c.read_restricted = false)", force: :cascade do |t|
    ...
    t.index ["bannered_until"], name: "index_topics_on_bannered_until"
    t.index ["bumped_at", "created_at", "updated_at"], name: "index_topics_on_timestamps_private"
    ...
    t.index ["id"], name: "index_topics_on_id_filtered_banner", unique: true
    ...
    t.index ["pinned_until"], name: "index_topics_on_pinned_until"
  ...
  create_table "translation_overrides", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "locale", null: false
    t.string "translation_key", null: false
    t.string "value", null: false
    t.datetime "created_at", null: false
  ...
  create_table "unsubscribe_keys", primary_key: "key", id: { type: :string, limit: 64 }, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "uploads", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "original_filename", null: false
  ...
  create_table "user_actions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "action_type", null: false
    t.integer "user_id", null: false
    ...
    t.index ["action_type", "user_id", "target_topic_id", "target_post_id", "acting_user_id"], name: "idx_unique_rows"
  ...
  create_table "user_api_keys", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "user_archived_messages", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_associated_accounts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "user_auth_token_logs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "action", null: false
  ...
  create_table "user_custom_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "name", limit: 256, null: false
    t.text "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "user_id"], name: "idx_user_custom_fields_last_reminded_at", unique: true
    t.index ["name", "user_id"], name: "idx_user_custom_fields_remind_assigns_frequency", unique: true
    t.index ["user_id", "name"], name: "index_user_custom_fields_on_user_id_and_name"
  end

  create_table "user_emails", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    ...
    t.index ["lower_email"], name: "index_user_emails_on_lower_email", unique: true
    t.index ["user_id"], name: "index_user_emails_on_user_id"
  end

  create_table "user_exports", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "user_field_options", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "user_fields", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "user_histories", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "action", null: false
    t.integer "acting_user_id"
    t.integer "target_user_id"
  ...
  create_table "user_open_ids", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "email", null: false
    t.string "url", null: false
    t.datetime "created_at", null: false
  ...
  create_table "user_options", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "user_profile_views", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "user_profiles", primary_key: "user_id", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "location"
    t.string "website"
    t.text "bio_raw"
    t.text "bio_cooked"
  ...
  create_table "user_search_data", primary_key: "user_id", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "search_data"
    t.text "raw_data"
    t.text "locale"
    t.integer "version", default: 0
  ...
  create_table "user_second_factors", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "user_stats", primary_key: "user_id", id: :integer, default: nil, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "user_uploads", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "upload_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "user_warnings", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "topic_id", null: false
    t.integer "user_id", null: false
    t.integer "created_by_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "watched_words", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "web_crawler_requests", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.date "date", null: false
  ...
  create_table "web_hook_event_types", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
  end

  create_table "web_hook_event_types_hooks", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "web_hook_id", null: false
  ...
  create_table "web_hook_events", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "web_hook_id", null: false
    t.text "headers"
    t.text "payload"
  ...
  create_table "web_hooks", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
